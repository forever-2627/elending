        ...
        <div class="row">
            <div class="col-12 col-xl-12 stretch-card">
                <div id="calc_card" class="card">
                    ...
                    <div class="card-body">
                        <h6 class="card-title">Repayments Input Form</h6>
                        <i class="fa fa-remove"></i>
                        <form method="post" action="{{route('staff.repayments.store')}}" id="myForm" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <select id="loan_id" name="loan_id" class="form-control">
                                            @php
                                                $loans = \App\Models\Loan::with('user')->where(['state' => 1])->get();
                                            @endphp
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="repaid_date" name="repaid_date" class="form-control" value="{{ old('repaid_date') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" id="repaid_amount" name="repaid_amount" class="form-control" value="{{ old('repaid_amount') }}">
                                    </div>
                                </div>
                            </div>
