                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="property_name"
                                                ...
                                                value="@if ($errors->any()) {{ old('property_name') }}@else{{ $property->property_name }} @endif">
                                            @error('property_name')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="lowest_price"
                                                ...
                                                value="@if ($errors->any()) {{ old('lowest_price') }}@else{{ $property->lowest_price }} @endif">
                                            @error('lowest_price')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="max_price"
                                                ...
                                                value="@if ($errors->any()) {{ old('max_price') }}@else{{ $property->max_price }} @endif">
                                            @error('max_price')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
